...
Finally, a pipeline may consist of a mixture of functions with varying insertion points. In these
cases, you'll need to use the more flexible variant, `as->`. For example, a pipeline may mix
map and sequence processing:
